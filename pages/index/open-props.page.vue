...
const siteData = reactive({
  ...
  description: `Open props page description`,
})
  ...
  <div id="top" class="page" role="document">
    <header role="banner">
      ...
      <p>
        ...
        >normalize</a> using Open Props! Minimal styles for all HTML elements. Plus, it's adaptive to light and dark. The props are made available for you to continue building
        <a
          href="https://codepen.io/argyleink/pen/jOLaBgG"
        >components</a> too.
      </p>
      <div>
  ...
  p q r s t u v w x y z { | } ~ </pre>
        ...
        <article id="text__inline">
          ...
          <div>
            ...
            <p>
              <q cite="./index_files/q">This text is a short inline quotation.</q>
            </p>
            <p>
      ...
      <section id="embedded">
        ...
        <article id="embedded__iframe">
          ...
          <div>
            <iframe src="./open-props" height="300"></iframe>
          </div>
        </article>
      </section>
      <section id="forms">
        ...
        <form>
          ...
          <fieldset id="forms__radio">
            ...
            <ul class="list list--bare">
              <li>
                <label for="radio1">
                  <input id="radio1" name="radio" type="radio" class="radio" checked /> Option 1
                </label>
              </li>
              <li>
                <label for="radio2">
